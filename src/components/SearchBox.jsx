...
export default function SearchBox() {
  ...
  return (
    <form className="flex items-center border border-grau-200 rounded-full shadow-lg px-6 py-3 ml-10 mr-5 flex-grow max-2-3xl" onSubmit={handleSubmit}>
      ...
      <AiOutlineSearch className="hidden sm:inline-flex text-2xl text-gray-500 cursor-pointer" onClick={handleSubmit} />
    </form>
  )
}
